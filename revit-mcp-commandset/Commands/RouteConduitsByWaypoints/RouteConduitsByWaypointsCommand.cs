// Commands/RouteConduitsByWaypoints/RouteConduitsByWaypointsyCommand.cs
...
namespace RevitMCPCommandSet.Commands.RouteConduitsByWaypoints
{
    ...
    /// }
    /// </summary>
    public class RouteConduitsByWaypointsCommand : ExternalEventCommandBase
    {
        ...
        /// 這裡只先解析 start/end element id，交給 EventHandler。
        /// </summary>
        /// 
        public override object Execute(JObject parameters, string requestId)
        {
            try
            {
                ...
                {
                    var tasks = tasksToken.ToObject<List<ConduitRouteTaskInfo>>() ?? new List<ConduitRouteTaskInfo>();
                ...
                var task = taskToken.ToObject<ConduitRouteTaskInfo>();
